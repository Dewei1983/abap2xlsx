...
public section.
  ...
  constants C_DARK1 type STRING value 'dk1' ##NO_TEXT.
  constants C_DARK2 type STRING value 'dk2' ##NO_TEXT.
  constants C_LIGHT1 type STRING value 'lt1' ##NO_TEXT.
  constants C_LIGHT2 type STRING value 'lt2' ##NO_TEXT.
  constants C_ACCENT1 type STRING value 'accent1' ##NO_TEXT.
  constants C_ACCENT2 type STRING value 'accent2' ##NO_TEXT.
  constants C_ACCENT3 type STRING value 'accent3' ##NO_TEXT.
  constants C_ACCENT4 type STRING value 'accent4' ##NO_TEXT.
  constants C_ACCENT5 type STRING value 'accent5' ##NO_TEXT.
  constants C_ACCENT6 type STRING value 'accent6' ##NO_TEXT.
  constants C_HLINK type STRING value 'hlink' ##NO_TEXT.
  constants C_FOLHLINK type STRING value 'folHlink' ##NO_TEXT.
  constants C_SYSCOLOR type STRING value 'sysClr' ##NO_TEXT.
  constants C_SRGBCOLOR type STRING value 'srgbClr' ##NO_TEXT.
  constants C_VAL type STRING value 'val' ##NO_TEXT.
  constants C_LASTCLR type STRING value 'lastClr' ##NO_TEXT.
  constants C_NAME type STRING value 'name' ##NO_TEXT.
  constants C_SCHEME type STRING value 'clrScheme' ##NO_TEXT.
