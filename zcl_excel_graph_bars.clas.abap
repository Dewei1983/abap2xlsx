...
public section.
  ...
  data NS_BARDIRVAL type STRING value 'col' ##NO_TEXT.
  constants C_GROUPINGVAL_CLUSTERED type STRING value 'clustered' ##NO_TEXT.
  constants C_GROUPINGVAL_STACKED type STRING value 'stacked' ##NO_TEXT.
  data NS_GROUPINGVAL type STRING value C_GROUPINGVAL_CLUSTERED ##NO_TEXT.
  data NS_VARYCOLORSVAL type STRING value '0' ##NO_TEXT.
  ...
  data NS_GAPWIDTHVAL type STRING value '150' ##NO_TEXT.
  data AXES type T_AX .
  constants:
    C_VALAX type c length 5 value 'VALAX' ##NO_TEXT.
  constants:
    C_CATAX type c length 5 value 'CATAX' ##NO_TEXT.
  data NS_LEGENDPOSVAL type STRING value 'r' ##NO_TEXT.
  data NS_OVERLAYVAL type STRING value '0' ##NO_TEXT.
  constants C_INVERTIFNEGATIVE_YES type STRING value '1' ##NO_TEXT.
  constants C_INVERTIFNEGATIVE_NO type STRING value '0' ##NO_TEXT.
