...
public section.
  ...
  constants C_SCHEME type STRING value 'fontScheme' ##NO_TEXT.
  constants C_MAJOR type STRING value 'majorFont' ##NO_TEXT.
  constants C_MINOR type STRING value 'minorFont' ##NO_TEXT.
  constants C_FONT type STRING value 'font' ##NO_TEXT.
  constants C_LATIN type STRING value 'latin' ##NO_TEXT.
  constants C_EA type STRING value 'ea' ##NO_TEXT.
  constants C_CS type STRING value 'cs' ##NO_TEXT.
  constants C_TYPEFACE type STRING value 'typeface' ##NO_TEXT.
  constants C_PANOSE type STRING value 'panose' ##NO_TEXT.
  constants C_PITCHFAMILY type STRING value 'pitchFamily' ##NO_TEXT.
  constants C_CHARSET type STRING value 'charset' ##NO_TEXT.
  constants C_SCRIPT type STRING value 'script' ##NO_TEXT.
