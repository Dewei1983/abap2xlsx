...
public section.
  ...
  data NS_1904VAL type STRING value '0' ##NO_TEXT.
  data NS_LANGVAL type STRING value 'it-IT' ##NO_TEXT.
  data NS_ROUNDEDCORNERSVAL type STRING value '0' ##NO_TEXT.
  data PAGEMARGINS type S_PAGEMARGINS .
  data NS_AUTOTITLEDELETEDVAL type STRING value '0' ##NO_TEXT.
  data NS_PLOTVISONLYVAL type STRING value '1' ##NO_TEXT.
  data NS_DISPBLANKSASVAL type STRING value 'gap' ##NO_TEXT.
  data NS_SHOWDLBLSOVERMAXVAL type STRING value '0' ##NO_TEXT.
  data SERIES type T_SERIES .
  data NS_C14STYLEVAL type STRING value '102' ##NO_TEXT.
  data PRINT_LABEL type C value 'X' ##NO_TEXT.
  data NS_STYLEVAL type STRING value '2' ##NO_TEXT.
  constants:
  ...
  constants:
    BEGIN OF c_style_48,
             ...
             END OF c_style_48 .
  constants C_SHOW_TRUE type C value '1' ##NO_TEXT.
  constants C_SHOW_FALSE type C value '0' ##NO_TEXT.
  constants C_PRINT_LBL_TRUE type C value '1' ##NO_TEXT.
  constants C_PRINT_LBL_FALSE type C value '0' ##NO_TEXT.
