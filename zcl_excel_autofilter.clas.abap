...
public section.
  ...
  constants MC_FILTER_RULE_SINGLE_VALUES type TV_FILTER_RULE value 'single_values' ##NO_TEXT.
  constants MC_FILTER_RULE_TEXT_PATTERN type TV_FILTER_RULE value 'text_pattern' ##NO_TEXT.
  constants MC_LOGICAL_OPERATOR_AND type TV_LOGICAL_OPERATOR value 'and' ##NO_TEXT.
  constants MC_LOGICAL_OPERATOR_NONE type TV_LOGICAL_OPERATOR value SPACE ##NO_TEXT.
  constants MC_LOGICAL_OPERATOR_OR type TV_LOGICAL_OPERATOR value 'or' ##NO_TEXT.
