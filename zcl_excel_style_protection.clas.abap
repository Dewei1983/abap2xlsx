...
public section.
  ...
  constants C_PROTECTION_HIDDEN type ZEXCEL_CELL_PROTECTION value '1' ##NO_TEXT.
  constants C_PROTECTION_LOCKED type ZEXCEL_CELL_PROTECTION value '1' ##NO_TEXT.
  constants C_PROTECTION_UNHIDDEN type ZEXCEL_CELL_PROTECTION value '0' ##NO_TEXT.
  constants C_PROTECTION_UNLOCKED type ZEXCEL_CELL_PROTECTION value '0' ##NO_TEXT.
