...
public section.
  ...
  constants C_THEME_ELEMENTS type STRING value 'themeElements' ##NO_TEXT.
  constants C_THEME_OBJECT_DEF type STRING value 'objectDefaults' ##NO_TEXT.
  constants C_THEME_EXTRA_COLOR type STRING value 'extraClrSchemeLst' ##NO_TEXT.
  constants C_THEME_EXTLST type STRING value 'extLst' ##NO_TEXT.
  constants C_THEME type STRING value 'theme' ##NO_TEXT.
  constants C_THEME_NAME type STRING value 'name' ##NO_TEXT.
  constants C_THEME_XMLNS type STRING value 'xmlns:a' ##NO_TEXT.
  constants C_THEME_PREFIX type STRING value 'a' ##NO_TEXT.
  constants C_THEME_PREFIX_WRITE type STRING value 'a:' ##NO_TEXT.
  constants C_THEME_XMLNS_VAL type STRING value 'http://schemas.openxmlformats.org/drawingml/2006/main' ##NO_TEXT.
