interface ZIF_EXCEL_SHEET_PROTECTION
  ...
  constants C_ACTIVE type ZEXCEL_SHEET_PROTECTION_BOOL value '1' ##NO_TEXT.
  constants C_NOACTIVE type ZEXCEL_SHEET_PROTECTION_BOOL value '0' ##NO_TEXT.
  constants C_PROTECTED type ZEXCEL_SHEET_PROTECTION value 'X' ##NO_TEXT.
  constants C_UNPROTECTED type ZEXCEL_SHEET_PROTECTION value '' ##NO_TEXT.
