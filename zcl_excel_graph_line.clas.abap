...
public section.
  ...
  data NS_GROUPINGVAL type STRING value 'standard' ##NO_TEXT.
  ...
  data NS_MARKERVAL type STRING value '1' ##NO_TEXT.
  data NS_SMOOTHVAL type STRING value '0' ##NO_TEXT.
  data AXES type T_AX .
  constants:
  ...
  constants C_SYMBOL_AUTO type STRING value 'auto' ##NO_TEXT.
  constants C_SYMBOL_NONE type STRING value 'none' ##NO_TEXT.
