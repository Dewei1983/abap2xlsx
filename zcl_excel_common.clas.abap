...
public section.
  ...
  constants C_EXCEL_BASELINE_DATE type D value '19000101' ##NO_TEXT.
  class-data C_EXCEL_NUMFMT_OFFSET type INT1 value 164 ##NO_TEXT.
  constants C_EXCEL_SHEET_MAX_COL type INT4 value 16384 ##NO_TEXT.
  constants C_EXCEL_SHEET_MIN_COL type INT4 value 1 ##NO_TEXT.
  constants C_EXCEL_SHEET_MAX_ROW type INT4 value 1048576 ##NO_TEXT.
  constants C_EXCEL_SHEET_MIN_ROW type INT4 value 1 ##NO_TEXT.
  class-data C_SPRAS_EN type SPRAS value 'E' ##NO_TEXT.
  class-data O_CONV type ref to CL_ABAP_CONV_OUT_CE .
  constants C_EXCEL_1900_LEAP_YEAR type D value '19000228' ##NO_TEXT.
  class-data C_XLSX_FILE_FILTER type STRING value 'Excel Workbook (*.xlsx)|*.xlsx|' ##NO_TEXT.
...
private section.
  ...
  class-data C_EXCEL_COL_MODULE type INT2 value 64 ##NO_TEXT.
