...
private section.
  ...
  class-data DELIMITER type CHAR01 value ';' ##NO_TEXT.
  class-data ENCLOSURE type CHAR01 value '"' ##NO_TEXT.
  class-data EOL type CHAR01 value CL_ABAP_CHAR_UTILITIES=>CR_LF ##NO_TEXT.
