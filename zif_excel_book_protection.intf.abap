interface ZIF_EXCEL_BOOK_PROTECTION
  ...
  constants C_LOCKED type ZEXCEL_BOOK_PROTECTION value '1' ##NO_TEXT.
  constants C_PROTECTED type ZEXCEL_BOOK_PROTECTION value 'X' ##NO_TEXT.
  constants C_UNLOCKED type ZEXCEL_BOOK_PROTECTION value '0' ##NO_TEXT.
  constants C_UNPROTECTED type ZEXCEL_BOOK_PROTECTION value '' ##NO_TEXT.
