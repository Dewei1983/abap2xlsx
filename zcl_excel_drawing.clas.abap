...
public section.
  ...
  constants C_GRAPH_PIE type ZEXCEL_GRAPH_TYPE value 1 ##NO_TEXT.
  constants C_GRAPH_LINE type ZEXCEL_GRAPH_TYPE value 2 ##NO_TEXT.
  constants C_GRAPH_BARS type ZEXCEL_GRAPH_TYPE value 0 ##NO_TEXT.
  data GRAPH_TYPE type ZEXCEL_GRAPH_TYPE .
  data TITLE type STRING value 'image1.jpg' ##NO_TEXT.
  data X_REFERENCES type CHAR1 .
  data Y_REFERENCES type CHAR1 .
  constants TYPE_IMAGE type ZEXCEL_DRAWING_TYPE value 'image' ##NO_TEXT.
  constants TYPE_CHART type ZEXCEL_DRAWING_TYPE value 'chart' ##NO_TEXT.
  constants ANCHOR_ABSOLUTE type ZEXCEL_DRAWING_ANCHOR value 'ABS' ##NO_TEXT.
  constants ANCHOR_ONE_CELL type ZEXCEL_DRAWING_ANCHOR value 'ONE' ##NO_TEXT.
  constants ANCHOR_TWO_CELL type ZEXCEL_DRAWING_ANCHOR value 'TWO' ##NO_TEXT.
  data GRAPH type ref to ZCL_EXCEL_GRAPH .
  constants C_MEDIA_TYPE_BMP type STRING value 'bmp' ##NO_TEXT.
  constants C_MEDIA_TYPE_XML type STRING value 'xml' ##NO_TEXT.
  constants C_MEDIA_TYPE_JPG type STRING value 'jpg' ##NO_TEXT.
...
private section.
  ...
  data TYPE type ZEXCEL_DRAWING_TYPE value TYPE_IMAGE ##NO_TEXT.
  data INDEX type STRING .
  data ANCHOR type ZEXCEL_DRAWING_ANCHOR value ANCHOR_ONE_CELL ##NO_TEXT.
  constants C_MEDIA_SOURCE_WWW type CHAR1 value 1 ##NO_TEXT.
  constants C_MEDIA_SOURCE_XSTRING type CHAR1 value 0 ##NO_TEXT.
  constants C_MEDIA_SOURCE_MIME type CHAR1 value 2 ##NO_TEXT.
