...
public section.
  ...
  constants C_COLOR_SCHEME type STRING value 'clrScheme' ##NO_TEXT.
  constants C_FONT_SCHEME type STRING value 'fontScheme' ##NO_TEXT.
  constants C_FMT_SCHEME type STRING value 'fmtScheme' ##NO_TEXT.
