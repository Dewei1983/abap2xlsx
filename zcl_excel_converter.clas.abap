...
protected section.
  ...
  data W_ROW_INT type ZEXCEL_CELL_ROW value 1 ##NO_TEXT.
  data W_COL_INT type ZEXCEL_CELL_COLUMN value 1 ##NO_TEXT.
private section.
  ...
  constants C_TYPE_HDR type CHAR1 value 'H' ##NO_TEXT.
  constants C_TYPE_STR type CHAR1 value 'P' ##NO_TEXT.
  constants C_TYPE_NOR type CHAR1 value 'N' ##NO_TEXT.
  constants C_TYPE_SUB type CHAR1 value 'S' ##NO_TEXT.
  constants C_TYPE_TOT type CHAR1 value 'T' ##NO_TEXT.
